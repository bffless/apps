...
| UI — the selected step | the run page **route** (the Summary, `/job/<job>[/<index>]`, `?step=<key>` on a job route — 08) | linkable; Back climbs out of a step; a navigation to another run drops it |
