...
${indent}${end}`;
  ...
  function handler(data) {
    ...
    const run = admittedRun(data.steps);
    ...
    if (route.tool === "workflow.submit" || route.tool === "workflow.submitStep") {
      ...
      const noValues = raw === void 0 || isPlainObject5(raw) && Object.keys(raw).length === 0;
      ...
      if (kind === "form") {
        ...
        const fields3 = isPlainObject5(inputs.fields) ? inputs.fields : null;
