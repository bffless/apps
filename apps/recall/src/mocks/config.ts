 ...
 * error (e.g. an edge 502) is in play, or for exercising the live j5s.dev rule
 * set instead of the canned fixtures.
 *
 * Ported verbatim from Studio's `src/mocks/config.ts`.
 *
