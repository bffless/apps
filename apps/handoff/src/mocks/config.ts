 ...
 *   4. default: on.
 *
 * This is independent of any per-handler flag (which only decides whether the
 * *handoff* handlers are mocked vs. passed through). If this master switch is
 * off, the worker isn't running, so nothing is mocked regardless.
 */
const KEY = 'mocks'
