...
export const USAGE = `workflow-live walk <m1|interactive|hello|headless|studio-audit|studio-headless|page-tools|mcp|mcp-app|oauth|driven|all>
...
export interface WalkArgs {
  ...
  clip?: string
  run?: string
  /** mcp: parks on the island · mcp-app: parks on the form (through the page tools, prints the id, stops). */
  parkOnly: boolean
  timeoutMs: number
}
